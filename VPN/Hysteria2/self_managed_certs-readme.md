...
The assumption is that you already have VLESS installed (https://github.com/alexeytz/homelab/tree/main/VPN/VLESS), and we'll use some hy2-installed stuff for Hysteria2.
